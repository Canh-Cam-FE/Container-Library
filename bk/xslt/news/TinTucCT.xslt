...
<xsl:output method="html" indent="yes"/>
	<xsl:template match="/">
					...
					<div class="col-lg-3 scroll-on-desktop">
						<div class="main-other">
							...
							<div class="main-item">
								...
								<div class="item"><a href="/tin-tuc-su-kien#news1">Xem thêm</a></div>
							</div>
						</div>
						<div class="main-other" style="margin-top: 15px">
							...
							<div class="main-item">
								...
								<div class="item"><a href="tin-tuc-su-kien#news2">Xem thêm</a></div>
							</div>
						</div>
					</div>
				</div>
		...
		<section class="tvc-news-detail-1 pt">
			<div class="container">
				<div class="row">
					<div class="col-lg-9 no-event"></div>
					<div class="col-lg-3 scroll-on-desktop">
						<div class="main-other">
							<div class="title">
								<h2>Tin tức khác</h2>
